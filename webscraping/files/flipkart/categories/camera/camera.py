...
with open('camera.csv','w') as f:
    f.write(header)
for page in range(1,24):
    req = session.get(f"https://www.flipkart.com/search?q=camera&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off&page={page}")
    ...
    for item in data:
        ...
        with open('camera.csv','a',encoding='UTF8') as f:
             f.write(str_)
